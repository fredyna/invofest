        ...
        <div id="beranda" class="page-header page-header-small">
            ...
            <div class="container">
                <div class="content-center">
                    ...
                    <h5 class="wow shake" data-wow-duration="1s" data-wow-delay="0.5s" style="color: #BA853A;font-weight:600;margin-bottom:3%;">UI/UX DESIGN</h5>
        ...
        <div class="section section-deskripsi">
            <div class="container">
                ...
                <p class="text-justify wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.75s">
                    Salah satu subkategori workshop Invofest 2018 di mana peserta akan mempelajari <i>User Interface</i> dan <i>User Experience Design</i> masa kini.
                </p>
                <br/><br/>
                ...
                <div id="narasumber" class="row justify-content-center">
                    <div class="col-md-5 text-center wow zoomIn" data-wow-duration="0.5s" data-wow-delay="1s" style="margin:2%;">
                        <img src="{{ url('img/tokoh/afnizar.png') }}" alt="AFNIZAR NUR GHIFARI" width="200px" class="mx-auto d-block">
                        <br />
                        <h5>AFNIZAR NUR GHIFARI</h5>
                        <p>UX Designer Bukalapak</p>
                    </div>
                ...
                <table class="wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="1s">
                    <tr>
                        <td style="width:150px;">Angga Dwiyono</td>
                        <td class="text-right"> : </td>
                        <td>0822 2641 7592</td>
                    </tr>
                </table>
            </div>
        </div>
